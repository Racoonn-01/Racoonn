...
databases.getDocument('6a3cec630035d63ea963', '6a3e0fd9da7df0d38588', '6a44e9d4003015938636').then(res => console.log(JSON.stringify(res.$permissions, null, 2))).catch(console.error);
