...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-slate-50 pb-24 text-slate-800 font-sans selection:bg-brand-soft-coral selection:text-[#1F2E4A]">
      
      {/* Hero Header Banner */}
      <div className="relative bg-[#1F2E4A] text-white overflow-hidden">
        {/* Abstract Background Elements */}
        <div className="absolute inset-0 z-0">
          <div className="absolute -top-[20%] -right-[10%] w-[50%] h-[50%] rounded-full bg-[#E86A70]/20 blur-[100px]" />
          <div className="absolute bottom-[0%] left-[0%] w-[40%] h-[40%] rounded-full bg-[#DCE8F5]/20 blur-[100px]" />
        </div>
        
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-32 pb-24 flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-[#F4F0EA] text-sm font-semibold tracking-wide mb-6">
            <ShieldCheck size={16} /> Privacy & Security
          </div>
          <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-[#F4F0EA] to-[#DCE8F5]">
            Privacy Policy
          </h1>
        ...
        {/* Bottom Curve */}
        <div className="absolute bottom-0 w-full h-12 bg-slate-50" style={{ clipPath: 'polygon(0 100%, 100% 100%, 100% 0, 0 100%)' }}></div>
      </div>
              ...
              <nav className="space-y-1">
                {sections.map((section) => (
                  <a 
                    key={section.id} 
                    href={`#${section.id}`}
                    className="flex items-center justify-between group px-4 py-3 rounded-2xl hover:bg-slate-50 transition-colors text-slate-600 hover:text-[#1F2E4A] font-medium"
                  >
                    <div className="flex items-center gap-3">
                      <section.icon size={18} className="text-slate-400 group-hover:text-[#E86A70] transition-colors" />
          ...
          <div className="flex-1 space-y-12">
            ...
            <section id="information-collection" className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-12 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-4 mb-6 pb-6 border-b border-slate-100">
                <div className="w-12 h-12 rounded-2xl bg-[#F8D6D8]/50 text-[#E86A70] flex items-center justify-center shrink-0">
                  <Database size={24} />
                </div>
                <h2 className="text-2xl md:text-3xl font-black text-[#1F2E4A]">1. Information We Collect</h2>
              </div>
              <div className="prose prose-slate prose-lg max-w-none text-slate-600 font-normal leading-relaxed">
                ...
                <ul className="list-disc pl-6 space-y-2 mt-4 marker:text-[#E86A70]">
            ...
            <section id="how-we-use" className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-12 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-4 mb-6 pb-6 border-b border-slate-100">
                ...
                <h2 className="text-2xl md:text-3xl font-black text-[#1F2E4A]">2. How We Use Your Data</h2>
              </div>
              <div className="prose prose-slate prose-lg max-w-none text-slate-600 font-normal leading-relaxed">
                <p>
            ...
            <section id="data-sharing" className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-12 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-4 mb-6 pb-6 border-b border-slate-100">
                ...
                <h2 className="text-2xl md:text-3xl font-black text-[#1F2E4A]">3. Data Sharing & Vendors</h2>
              </div>
              <div className="prose prose-slate prose-lg max-w-none text-slate-600 font-normal leading-relaxed">
                <p>
                ...
                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 mt-6">
                  <h4 className="font-bold text-[#1F2E4A] mb-2">Hotel Partners (Vendors)</h4>
            ...
            <section id="data-security" className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-12 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-4 mb-6 pb-6 border-b border-slate-100">
                ...
                <h2 className="text-2xl md:text-3xl font-black text-[#1F2E4A]">4. Data Security</h2>
              </div>
              <div className="prose prose-slate prose-lg max-w-none text-slate-600 font-normal leading-relaxed">
                <p>
            ...
            <section className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-12 hover:shadow-md transition-shadow space-y-12">
              ...
              <div id="cookies">
                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-slate-100">
                  ...
                  <h2 className="text-2xl md:text-3xl font-black text-[#1F2E4A]">5. Cookies & Tracking</h2>
                </div>
                <div className="prose prose-slate prose-lg max-w-none text-slate-600 font-normal leading-relaxed">
                  <p>
              ...
              <div id="data-retention">
                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-slate-100">
                  ...
                  <h2 className="text-2xl md:text-3xl font-black text-[#1F2E4A]">6. Data Retention</h2>
                </div>
                <div className="prose prose-slate prose-lg max-w-none text-slate-600 font-normal leading-relaxed">
                  <p>
            ...
            <section id="contact" className="bg-[#1F2E4A] rounded-3xl shadow-xl p-8 md:p-12 text-white overflow-hidden relative">
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#E86A70]/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
