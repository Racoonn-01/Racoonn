                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    <div className="p-5 rounded-[20px] bg-[#0f172a] border border-[#1e293b] space-y-1.5 font-mono text-xs shadow-2xl relative overflow-hidden group hover:-translate-y-1 transition-transform">
                      <div className="absolute inset-0 bg-gradient-to-br from-[#ff5f56]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    ...
                    <div className="p-5 rounded-[20px] bg-[#0f172a] border border-[#1e293b] space-y-1.5 font-mono text-xs shadow-2xl relative overflow-hidden group hover:-translate-y-1 transition-transform">
                      <div className="absolute inset-0 bg-gradient-to-br from-[#27c93f]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    ...
                    <div className="p-5 rounded-[20px] bg-[#0f172a] border border-[#1e293b] space-y-1.5 font-mono text-xs shadow-2xl relative overflow-hidden group hover:-translate-y-1 transition-transform">
                      <div className="absolute inset-0 bg-gradient-to-br from-[#ffbd2e]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
