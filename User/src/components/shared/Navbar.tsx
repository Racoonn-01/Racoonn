        ...
        {isSidebarOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 bg-brand-navy/60 z-50"
            />
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-95 max-w-[85vw] bg-white z-50 shadow-2xl flex flex-col will-change-transform transform-gpu"
            >
              {/* Header */}
