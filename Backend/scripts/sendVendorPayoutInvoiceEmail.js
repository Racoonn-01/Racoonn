...
async function main() {
  const recipientEmail = "blackrolex1144@gmail.com";
  console.log(`Preparing to send Vendor Payout Withdrawal Invoice to ${recipientEmail}...`);
  ...
  const invoiceNumber = "INV-PAYOUT-2026-8942";
        ...
        <div class="invoice-box">
          ...
          <div class="grid-details">
            <div class="col">
              ...
              <div class="val-title">BlackRolex Stays & Luxury Villa</div>
              <div class="val-sub">Email: <strong>${recipientEmail}</strong></div>
              <div class="val-sub">Phone: <strong>+91 7900310444</strong></div>
              <div class="val-sub">Vendor ID: <strong>VND-984210</strong></div>
            </div>
            <div class="col">
              <div class="lbl">BANK PAYOUT ACCOUNT</div>
              <div class="val-title">State Bank of India (SBI)</div>
              <div class="val-sub">A/C Holder: <strong>BlackRolex Hospitality</strong></div>
              <div class="val-sub">A/C No: <strong>XXXXXX9842</strong> | IFSC: <strong>SBIN0004821</strong></div>
              <div class="val-sub">UPI ID: <strong>blackrolex1144@okaxis</strong></div>
            </div>
          </div>
          ...
          <table class="table-box">
            ...
            <tbody>
              <tr>
                ...
                <td>5 Bookings</td>
                <td>₹28,500</td>
                <td style="text-align: right; font-weight: 700;">₹28,500</td>
              </tr>
              <tr>
                <td>
                ...
                <td>-</td>
                <td>-18%</td>
                <td style="text-align: right; font-weight: 700; color: #DC2626;">-₹5,130</td>
              </tr>
              <tr>
                <td>
                ...
                <td>-</td>
                <td>18% GST</td>
                <td style="text-align: right; font-weight: 700; color: #DC2626;">-₹923.40</td>
              </tr>
            </tbody>
          </table>
            ...
            <div class="total-row">
              <div>
                ...
                <div style="font-size: 11px; color: #64748B; margin-top: 3px;">
                  Directly credited to your registered SBI Bank Account / UPI ID
                </div>
              </div>
              <div class="total-val">₹22,446.60</div>
            </div>
          </div>
  ...
  console.log("SUCCESS! Email sent to blackrolex1144@gmail.com with Message ID:", info.messageId);
}

main().catch(err => {
  console.error("Failed to send vendor payout email:", err);
});
